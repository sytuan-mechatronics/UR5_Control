"""Manual Phase-2 test tool - motion + vision + pick-place single part.
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--station", default="phase2_manual_test", help="Station name")
    parser.add_argument(
        "--workflow-id",
...
def main() -> int:
    ...
    print("Mode: motion + vision + pick-place 1 phoi")
    ...
    try:
        ...
        exit_code = 130
        print("\nPhase 2 ABORTED by user.")
    except Exception as exc:
        exit_code = 1
        print(f"\nPhase 2 THAT BAI: {exc}")
        traceback.print_exc()
    finally:
        for client, name in [
            (gripper, "gripper"),
