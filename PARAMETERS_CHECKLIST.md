...
### Lưu vào .env:
```bash
export CAM_FX="1114.278564453125"
export CAM_FY="1114.118408203125"
export CAM_CX="937.609375"
export CAM_CY="518.2891845703125"
```
...
# Update config:
export YOLO_MODEL_PATH="models/phoi.pt"
